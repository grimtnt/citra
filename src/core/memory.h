...
enum : PAddr {
    ...
    FCRAM_N3DS_PADDR = 0x28000000, ///< Buffing Up the FCRAM N3DS for @ 0x08 ?
    FCRAM_N3DS_SIZE = 0x08000000, ///< 0x28 + FCRAM size on the New 3DS = (256MB)
    FCRAM_PADDR_END = FCRAM_PADDR + FCRAM_SIZE,
    FCRAM_N3DS_PADDR_END = FCRAM_PADDR + FCRAM_SIZE + FCRAM_N3DS_SIZE,_SIZE,
};
