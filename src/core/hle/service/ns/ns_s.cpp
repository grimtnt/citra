...
NS_S::NS_S() : ServiceFramework("ns:s", 2) {
    static const FunctionInfo functions[] = {
        ...
        {0x00030000, &NS_S::TerminateApplication, "TerminateApplication"},
        {0x00040040, &NS_S::TerminateProcess, "TerminateProcess"},
        ...
        {0x00110100, &NS_S::TerminateTitle, "TerminateTitle"},
        {0x001200C0, &NS_S::SetApplicationCpuTimeLimit, "SetApplicationCpuTimeLimit"},
        {0x00150140, &NS_S::LaunchApplication, "LaunchApplication"},
