...
void FindContentInfos(Service::Interface* self) {
    ...
    std::string tmd_path = GetTitlePath(media_type, title_id) + "content/00000000.tmd";
...
void GetProgramInfos(Service::Interface* self) {
    ...
    for (u32 i = 0; i < title_count; i++) {
        std::string tmd_path = GetTitlePath(media_type, title_id_list[i]) + "content/00000000.tmd";
