...
ControlPanel::ControlPanel(QWidget *parent) :
    ...
    connect(ui->network_state, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &ControlPanel::OnNetworkStateChanged);
...
void ControlPanel::OnNetworkStateChanged() {
    Settings::values.n_state =
            itns(ui->network_state->currentIndex());
